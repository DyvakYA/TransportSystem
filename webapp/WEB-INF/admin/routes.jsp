...
<fmt:bundle basename="labels">
    ...
    <div id="content">
        ...
        <table width="100%" cellspacing="1" border="1" cellpadding="1">
            ...
            <c:forEach items="${routesList}" var="item">
            <tr>
                <td><input type="radio" name="route_id" value="${item.id}"> <c:out value="${item.id}" /></td>
                <td><a href="./rest/find"><c:out value="${item.name}" /></a></td>
            </tr>
            </c:forEach>
        ...
        <form method="post" action="./TransportServlet">
            ...
            <select name="command">
                ...
                <option value="addStopToRoteCommand"><fmt:message key="AddStopToRouteCommand" /></option>
                <option value="RemoveStopFromRouteCommand"><fmt:message key="RemoveStopFromRouteCommand" /></option>
            </select><br>
