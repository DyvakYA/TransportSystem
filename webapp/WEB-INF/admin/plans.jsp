...
<fmt:bundle basename="labels">
    ...
    <div id="content">
        ...
        <table width="100%" cellspacing="1" border="1" cellpadding="1">
            <c:forEach var="plans" items="${plansList}">

                <tr>
                    <th><fmt:message key="Id" /></th>
                    <th><fmt:message key="RouteId" /></th>
                    <th><fmt:message key="TransportId" /></th>
                </tr>

                <tr>
                    <td>${plans.id}</td>
                    <td>${plans.routeId}</td>
                    <td>${plans.transportId}</td>
                </tr>
            </c:forEach>
        </table>
        ...
        <table>
            <tr>
                ...
                <td><fmt:message key="TransportId" /></td>
            </tr>
            <tr>
                <td><input type="text" name="plan_id"></td><br>
                <td><input type="text" name="route_id"></td><br>
                <td><input type="text" name="transport_id"></td><br>
            </tr>
            <tr>
                <td colspan="3"></td>
            </tr>
