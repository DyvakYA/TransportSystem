    ...
    <div id="content">
        ...
        <form method="post" action="./TransportServlet">
            <table>
                ...
                <tr>
                    <td><input type="text" name="driver_id"></input></td>
                    <td><input type="text" name="name"></input></td>
                    <td><input type="text" name="surname"></input></td>
                    <td><input type="text" name="age"></input></td>
                    <td><input type="text" name="route_id"></input></td>
                </tr>
                <tr>
                    <td colspan="3"></td>
                </tr>
            ...
            <select name="command">
                <option value="createDriver"><fmt:message
                        key="CreateCommand" /></option>
                <option value="updateDriver"><fmt:message
                        key="UpdateCommand" /></option>
                <option value="deleteDriver"><fmt:message
                        key="DeleteCommand" /></option>
                <option value="getAllDrivers"><fmt:message
