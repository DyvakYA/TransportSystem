    ...
    <div id="content">
        ...
        <form method="post" action="./TransportServlet">
            <table>
                ...
                <tr>
                    <td><input type="text" name="user_id" size="7"></td><br/>
                    <td><input type="text" name="name" size="7"></td><br/>
                    <td><input type="text" name="surname" size="7"></td><br/>
                    <td><input type="text" name="email" size="7"></td><br/>
                    <td><input type="text" name="password" size="7"></td><br/>
                    <td><select name="role">
                        <option>ADMIN</option>
                        <option>USER</option>
                    </select></td><br/>
            ...
            <select name="command">
                <option value="createUser"><fmt:message key="CreateCommand" /></option>
                <option value="updateUser"><fmt:message key="UpdateCommand" /></option>
                <option value="deleteUser"><fmt:message key="DeleteCommand" /></option>
                <option value="getAllUsers"><fmt:message key="GetAllCommand" /></option>
            </select>
            <button class="my_link_small" type="submit">
