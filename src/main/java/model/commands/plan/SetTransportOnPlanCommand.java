...
import static ua.kpi.epam.transport.commands.schedule.PlanCommand.*;
 ...
 * @author KIRIL
 */
public class SetTransportOnPlanCommand implements ScheduleCommand {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (!new ua.kpi.epam.transport.commands.validators.schedule.SetTransportOnPlanCommandValidator().validate(request, response)) {
            return;
        }
