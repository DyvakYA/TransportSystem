 ...
 * @author KIRIL
 */
public class CreatePlanCommand implements ScheduleCommand {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (!new ua.kpi.epam.transport.commands.validators.schedule.CreatePlanCommandValidator().validate(request, response)) {
            return;
        }
