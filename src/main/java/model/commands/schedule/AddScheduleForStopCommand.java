...
import ua.kpi.epam.transport.commands.validators.schedule.AddScheduleForStopCommandValidator;
 ...
 * @author KIRIL
 */
public class AddScheduleForStopCommand implements ScheduleCommand {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (!new AddScheduleForStopCommandValidator().validate(request, response)) {
            return;
        }
