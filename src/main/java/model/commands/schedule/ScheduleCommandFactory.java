...
public class ScheduleCommandFactory {
    ...
    private static final ScheduleCommandFactory instance = new ScheduleCommandFactory();

    private ScheduleCommandFactory() {
        super();
    }
     ...
     * @return
     */
    public static ScheduleCommandFactory getInstanse() {
        return instance;
    }
