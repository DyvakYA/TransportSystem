...
public class JdbcPlanOfStopsDao implements PlanOfStopsDao {
    ...
    private static final String SELECT_FROM_PLAN_OF_STOPS_WHERE_PLAN_OF_STOPS_ID = "SELECT * FROM plan_of_stops WHERE plan_of_stops_id=?";
    ...
    public PlanOfStops findById(int id) {
        ...
        try (PreparedStatement statement = connection
                .prepareStatement(SELECT_FROM_PLAN_OF_STOPS_WHERE_PLAN_OF_STOPS_ID)) {
